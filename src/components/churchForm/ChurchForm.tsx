...
interface ChurchFormProps {
    initialData?: Partial<Church> | null;
    onSubmit: (data: Church) => void;
    onCancel: () => void;
    isSubmitting: boolean;
    ministers: Minister[];
}

const ChurchForm: React.FC<ChurchFormProps> = ({ initialData, onSubmit, onCancel, isSubmitting, ministers }) => {
    ...
    const handleFormSubmit: SubmitHandler<Church> = (data) => {
        onSubmit(data);
    };;
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="church-form" noValidate>
            <div className="row g-3">
                    ...
                    <Controller name="registryNumber" control={control} rules={{ required: 'Número de registro é obrigatório' }}
                        render={({ field }) => (
                            <IMaskInput
                                ...
                                id="registryNumber" value={field.value || ''} onAccept={field.onChange}
                ...
                <div className="col-md-6 mb-3">
                    <label htmlFor="pastorLocalId" className="form-label">Pastor Local (Opcional)</label>
                    <select id="pastorLocalId" {...register('pastorLocalId')} className="form-select">
